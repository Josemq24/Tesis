        ...
        if(e.code === "Enter"){
            switch(contador){
                case 0: mensaje.push(chatInput.value)
                        contador += 1
                        chat.innerHTML += `<div class="flex w-full mt-2 space-x-3 max-w-xs ml-auto justify-end""><div class="bg-blue-600 text-white p-3 rounded-l-lg rounded-br-lg"><p class="text-sm font-bold"> ${chatInput.value} </p></div></div>`
